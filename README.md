...
This repository contains a hardened, honest workshop-only robotics paper draft for `open_robot_data_coverage_gaps`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/111.pdf`
