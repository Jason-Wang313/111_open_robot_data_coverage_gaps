...
Honest strongest claim: `Measure mechanism coverage gaps in open robot data beyond task and embodiment counts.` is a plausible branch-structured mechanism for open robot datasets, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
